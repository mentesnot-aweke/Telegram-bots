    ...
    <div className="bg-black w-full min-h-screen text-gray-200 p-4 md:p-8">
      ...
      <div className="flex  sm:flex-row justify-around gap-4 mb-6">
        <div className="bg-gray-800 p-4 rounded-md text-center">
          ...
          <p>More friends, better results!</p>
        </div>
        <div className="bg-gray-800 p-4 rounded-md text-center">
          <h2 className="text-xl font-semibold">{coin} Coins</h2>
          <p>Earn 10% of your friends' earnings</p>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          className="bg-yellow-500 hover:bg-yellow-400 text-black font-bold px-6 py-2 rounded-md flex items-center transition duration-300 ease-in-out"
          onClick={updateFriendsAndCoins}
        >
          Claim Rewards <GrFormNextLink className="ml-2" />
        </button>
      </div>
